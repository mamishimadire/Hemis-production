...
namespace HemisAudit.Services
{
    ...
    public class Rule60Service : IRule60Service
    {
        ...
        {
            new Rule41ColumnPair { StudCol = "_030", H16Col = "_030", Label = "Subject Code (_030)"  },
            new Rule41ColumnPair { StudCol = "_065", H16Col = "_065", Label = "_065"                 },
            new Rule41ColumnPair { StudCol = "_031", H16Col = "_031", Label = "_031"                 },
            new Rule41ColumnPair { StudCol = "_033", H16Col = "_033", Label = "_033"                 },
            new Rule41ColumnPair { StudCol = "_034", H16Col = "_034", Label = "_034"                 },
            new Rule41ColumnPair { StudCol = "_059", H16Col = "_059", Label = "_059"                 },
            new Rule41ColumnPair { StudCol = "_060", H16Col = "_060", Label = "_060"                 },
            new Rule41ColumnPair { StudCol = "_061", H16Col = "_061", Label = "_061"                 },
            new Rule41ColumnPair { StudCol = "_062", H16Col = "_062", Label = "_062"                 },
            new Rule41ColumnPair { StudCol = "_058", H16Col = "_058", Label = "_058"                 },
            new Rule41ColumnPair { StudCol = "_091", H16Col = "_091", Label = "_091"                 },
            new Rule41ColumnPair { StudCol = "_092", H16Col = "_092", Label = "_092"                 },
            new Rule41ColumnPair { StudCol = "_093", H16Col = "_093", Label = "_093"                 },
        };
        ...
        public async Task<Rule41TableDiscoveryResult> GetTablesAsync(int clientId)
        {
            try
            {
                ...
                return new Rule41TableDiscoveryResult
                {
                    ...
                    AutoH16Table = FindFirst(tables, ["H16CRSE", "H16_CRSE"], ["H16CRSE", "H16CR"])
                };
            }
        ...
        // secondaryKeyCol, when set, is combined with keyCol into a composite key — needed when
        // the primary key alone repeats, such as one row per qualification for the same student.
...
{fieldSel},
    CASE
        WHEN s.""{sk}"" IS NULL THEN 'MISSING-CRSE'
        WHEN a.""{ak}"" IS NULL THEN 'MISSING-H16CRSE'
...
-- ============================================================".Trim();
        ...
        private async Task<int> SaveValidationRunAsync(Rule41ValidationRequest request, Rule41ValidationSummary summary, string? userEmail, string? userName)
        {
            ...
            await _systemDb.MarkPreviousRuleRunsHistoricalAsync(request.ClientId, 60);

            var runId = await _systemDb.SaveValidationRunAsync(new SaveValidationRunRequest
            {
                ClientId = request.ClientId,
                RuleNumber = 60,
                RuleName = "CRSE vs H16CRSE Agreement",
        ...
        {
            var row = await _systemDb.GetCurrentRuleRunAsync(clientId, 60);
        ...
        {
            var row = await _systemDb.GetRuleRunByIdAsync(runId, 60);
            if (row == null) return null;
