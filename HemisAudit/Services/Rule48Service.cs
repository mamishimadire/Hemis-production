...
namespace HemisAudit.Services
{
    ...
    public class Rule48Service : IRule48Service
    {
        ...
        {
            new Rule41ColumnPair { StudCol = "_001", H16Col = "_001", Label = "Credential Code" },
            new Rule41ColumnPair { StudCol = "_030", H16Col = "_030", Label = "Course Code"     },
            new Rule41ColumnPair { StudCol = "_036", H16Col = "_036", Label = "_036"            },
        ...
        public async Task<Rule41TableDiscoveryResult> GetTablesAsync(int clientId)
        {
            try
            {
                ...
                return new Rule41TableDiscoveryResult
                {
                    ...
                    AutoH16Table = FindFirst(tables, ["H16CRED", "H16_CRED"], ["H16CRED", "H16CR"])
                };
            }
...
-- ============================================================".Trim();
        ...
        private async Task<int> SaveValidationRunAsync(Rule41ValidationRequest request, Rule41ValidationSummary summary, string? userEmail, string? userName)
        {
            ...
            await _systemDb.MarkPreviousRuleRunsHistoricalAsync(request.ClientId, 48);

            var runId = await _systemDb.SaveValidationRunAsync(new SaveValidationRunRequest
            {
                ClientId = request.ClientId,
                RuleNumber = 48,
                RuleName = "CRED vs H16CRED Agreement",
        ...
        {
            var row = await _systemDb.GetCurrentRuleRunAsync(clientId, 48);
        ...
        {
            var row = await _systemDb.GetRuleRunByIdAsync(runId, 48);
            if (row == null) return null;
