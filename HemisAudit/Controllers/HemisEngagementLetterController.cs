...
public class HemisEngagementLetterController : Controller
{
    ...
    private static void BuildDocument(MemoryStream ms)
    {
        ...
        body.Append(WordHelper.WPara(
            "Our staff members undergo periodic training and this, together with the taking of annual leave, may lead to staff turnover and lack of continuity. We will use our best endeavors to avoid any disruption to an engagement’s progress. Save as envisaged below, you agree not to make any offer of employment or to otherwise interfere with or entice away from the employment of any persons employed by Audit Firm. You further agree not to use such person’s services as an independent consultant or via a third party for a period of 12 months following the end of such person’s involvement, without the prior written consent of Audit Firm. This consent may not be unreasonably withheld.",
            afterPt: 4));
        body.Append(WordHelper.WPara(
            "Should you make any offer of employment to any person currently employed by Audit Firm or who was employed by Audit Firm for the immediately preceding 12 month period from the date of such offer of employment, you will be liable for and will pay to Audit Firm a placement fee equal to 25% of such employee’s total annual cost to entity, excluding Value Added Tax (“VAT”).",
            afterPt: 6));
        ...
        body.Append(WordHelper.WPara(
            "The maximum liability of Audit Firm their partners, directors, employees and agents for all claims arising out of services provided in connection with this engagement shall be limited to the total fees charged for all services provided in connection with this engagement. This maximum liability shall be an aggregate liability for all claims from whatsoever source and howsoever arising, whether in contract, delict or otherwise.",
            afterPt: 4));
        body.Append(WordHelper.WPara(
