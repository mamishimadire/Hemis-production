...
public class HemisEngagementLetterController : Controller
{
    ...
    private static void BuildDocument(MemoryStream ms)
    {
        ...
        body.Append(WordHelper.WPara(
            "HEMIS – Agreed Upon Procedures for the period ending xx December xxxx",
        ...
        body.Append(WordHelper.WPara(
            "We are pleased to confirm our acceptance of the engagement to perform the Agreed-Upon Procedures (AUP) on the Higher Education Management Information System (HEMIS) data submitted to the Department of Higher Education and Training (DHET) by ........ University for the period ending xx December xxxx. The terms of this engagement are as set out below.",
            afterPt: 8));

        // ── Section 1 ─────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("1.", "Background"));
        body.Append(WordHelper.WPara(
            "........ University (the \"University\") submits Higher Education Management Information System (HEMIS) data to the Department of Higher Education and Training (DHET) annually. In terms of the Higher Education Act, No 101 of 1997 (as amended), institutions are required to submit accurate and complete HEMIS data to the DHET. The DHET requires independent verification of the HEMIS data submitted by the University.",
            afterPt: 4));

        // ── Section 2 ─────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("2.", "Scope of the Engagement"));
        body.Append(WordHelper.WPara(
            "We will perform the following agreed-upon procedures as set out in the AUP report in respect of the HEMIS data submitted by the University to the DHET for the period ending xx December xxxx:",
            afterPt: 4));
        body.Append(WordHelper.IndentPara("Section 3:   General Procedures – SQLVALPAC Files to be Audited", leftTwips: 360));
        body.Append(WordHelper.IndentPara("Section 4:   Initial Checks", leftTwips: 360));
        body.Append(WordHelper.IndentPara("Section 5:   Qualification File", leftTwips: 360));
        body.Append(WordHelper.IndentPara("Section 6:   Course File", leftTwips: 360));
        body.Append(WordHelper.IndentPara("Section 7:   Credit Value File", leftTwips: 360));
        body.Append(WordHelper.IndentPara("Section 8:   Student File", leftTwips: 360));
        body.Append(WordHelper.IndentPara("Section 9:   Course Registration File", leftTwips: 360));
        body.Append(WordHelper.IndentPara("Section 11:  Staff Profile", leftTwips: 360));
        body.Append(WordHelper.IndentPara("Section 12:  Data Change Requests", leftTwips: 360));
        body.Append(WordHelper.IndentPara("Section 13:  Attachments", leftTwips: 360, afterPt: 6));
        ...
        body.Append(WordHelper.WPara(
            "The Executive Director: Institutional Effectiveness & Technology, as identified by ........ University, is responsible for the subject matter on which the agreed-upon procedures are performed, including the HEMIS data submitted to the DHET.",
            afterPt: 6));
        ...
        body.Append(WordHelper.WPara(
            "This engagement commences on the date of acceptance of this letter and concludes upon delivery of our report. The engagement covers the HEMIS data for the period ending xx December xxxx.",
            afterPt: 6));
        ...
        // ── Section 10 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("10.", "Confidentiality"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 11 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("11.", "Access to Records and Systems"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 12 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("12.", "Management Representation Letter"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 14 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("14.", "Restriction on Use and Distribution"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 15 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("15.", "Working Papers"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 16 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("16.", "Format of Report"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 17 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("17.", "Change in Agreed Procedures"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 18 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("18.", "Reliance on Information Provided"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 19 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("19.", "Our Personnel"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 20 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("20.", "Sub-Contracting"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 21 – Fees ────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("21.", "Fees"));
        body.Append(WordHelper.WPara(
        ...
        body.Append(WordHelper.SimpleTable(
            ["Subject", "xx May xxxx", "xx July xxxx", "Total"],
            ["HEMIS Audit", "50%", "50%", "100%"],
            ["Total", "50%", "50%", "100%"]
        ));
        ...
        // ── Section 22 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("22.", "Payment Terms"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 23 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("23.", "Intellectual Property"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 24 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("24.", "Limitation of Liability"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 25 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("25.", "Professional Indemnity Insurance"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 26 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("26.", "Data Privacy and Protection"));
        body.Append(WordHelper.WPara(
        ...
        // ── Section 27 ────────────────────────────────────────────────────────
        body.Append(WordHelper.ELSection("27.", "Dispute Resolution"));
        body.Append(WordHelper.WPara(
        ...
        body.Append(WordHelper.ELSection("28.", "Acceptance"));
        body.Append(WordHelper.WPara(
