...
namespace HemisAudit.Controllers
{
    ...
    public class Rule20Controller : Controller
    {
        ...
        public async Task<IActionResult> GetTables([FromBody] EngagementTableListRequest model) =>
            Json(await RequireDataAnalystAsync(async () => await _rule20.GetTablesAsync(model.ClientId)));

        [HttpPost]
        public async Task<IActionResult> GetColumns([FromBody] Rule16ColumnsRequest request) =>
            Json(await RequireDataAnalystAsync(async () => await _rule20.GetColumnsAsync(request.ClientId, request.TableName)));
        ...
        public async Task<IActionResult> RunValidation([FromBody] Rule20ValidationRequest request)
        {
            ...
            _logger.LogInformation(
                "Rule20 RunValidation requested by {Email}. ClientId={ClientId}, StudTable={StudTable}, QualTable={QualTable}, CregTable={CregTable}, CrseTable={CrseTable}",
                user?.Email,
                request.ClientId,
                request.StudTable,
                request.QualTable,
